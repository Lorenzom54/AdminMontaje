...
window.openModal = function(modalId) {
  console.log('Función global openModal llamada con:', modalId);
  if (window.modalManager) {
    console.log('ModalManager encontrado, llamando openModal');
...
window.closeModal = function(modalId) {
  console.log('Función global closeModal llamada con:', modalId);
  if (window.modalManager) {
    console.log('ModalManager encontrado, llamando closeModal');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('ModalManager completamente inicializado');
});