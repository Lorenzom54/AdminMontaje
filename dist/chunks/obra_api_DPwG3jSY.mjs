...
async function fetchObraById(id) {
...
// Crear nueva obra
async function addObra({ nombre, estado, fecha_inicio, fecha_fin, ubicacion, responsable, descripcion }) {
...
export { addObra as a, fetchObras as b, deleteObra as d, fetchObraById as f, searchObras as s, updateObra as u };
