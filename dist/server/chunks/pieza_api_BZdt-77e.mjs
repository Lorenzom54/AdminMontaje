...
async function importPiezasFromCSV(csvData) {
  try {
    const { data, error } = await supabase
      .from('piezas')
      .insert(csvData)
...
export { FASES as F, fetchChapasForSelect as a, fetchPiezas as b, addPieza as c, FASES_REVERSE as d, fetchPiezaById as e, fetchConjuntosForSelect as f, deletePieza as g, importPiezasFromCSV as i, searchPiezas as s, updatePieza as u };
