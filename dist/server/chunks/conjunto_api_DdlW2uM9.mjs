...
async function actualizarFasesConjunto(conjuntoId) {
  try {
    ...
    const { getObraFasesPiezas, getObraFasesConjuntos } = await import('./obra_api_D3QhXp__.mjs');
...
async function actualizarFasesTodosConjuntos() {
  try {
    // Obtener todos los conjuntos
...
export { fetchFaseConjuntosForSelect as a, fetchConjuntos as b, addConjunto as c, actualizarFasesTodosConjuntos as d, fetchConjuntoById as e, fetchObrasForSelect as f, deleteConjunto as g, fetchConjuntoByCodigo as h, searchConjuntos as s, updateConjunto as u };
