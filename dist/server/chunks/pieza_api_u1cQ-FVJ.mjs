...
async function fetchPiezasCount() {
...
async function searchPiezas(filters = {}, page = 1, pageSize = 20) {
  const offset = (page - 1) * pageSize;
...
async function searchPiezasCount(filters = {}) {
...
async function updatePiecesWithChapaId(pieceCode, count, chapaId) {
  try {
...
export { FASES as F, fetchChapasForSelect as a, searchPiezasCount as b, fetchPiezas as c, fetchPiezasCount as d, addPieza as e, fetchConjuntosForSelect as f, fetchPiezaById as g, updatePieza as h, deletePieza as i, searchPiezas as s, updatePiecesWithChapaId as u };
