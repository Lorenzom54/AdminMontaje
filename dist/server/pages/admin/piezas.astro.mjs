...
import { f as fetchConjuntosForSelect, a as fetchChapasForSelect, F as FASES, b as fetchPiezas } from '../../chunks/pieza_api_I-bZID2U.mjs';
/* empty css                                     */
import 'clsx';
import { f as fetchObrasForSelect } from '../../chunks/conjunto_api_r3FJjXTu.mjs';
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function filterTable() {
      ...
      tableRows.forEach(row => {
        ...
        const colada = row.cells[6].textContent.toLowerCase(); // Ajustar \xEDndice por nueva columna
